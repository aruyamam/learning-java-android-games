...
class AlienPatrolMovementComponent implements MovementComponent {
    ...
    public boolean move(long fps, Transform t, Transform playerTransform) {
        ...
        // Stop the alien gong too far away
        ...
        if (t.headingLeft()) {
            ...
            // Turn the ship around with it reaches the
            ...
            // Turn the ship around wit it reahces the
            // extent of its horizontal patrol area
        ...
        // Soot if  the alien within a ships height above,
