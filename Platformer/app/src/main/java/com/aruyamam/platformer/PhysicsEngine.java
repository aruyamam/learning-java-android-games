...
class PhysicsEngine {
    ...
    private void detectCollisions(GameState gs,
        ...
        // Get reference to the players position
        ...
        // Get the players extra colliders from the case object
                            ...
                            if (RectF.intersects(
                                ...
                                switch (go.getTag() + " with " + "" + i) {
                                    ...
                                    case "Inert Tile with 1": // Head
                                        ...
                                        // but allow any umps to continue
                                    ...
                                    case "Collective with 2": // Right
                                            SoundEngine.playCoinPickup();
                                            // Switch off coin
                                            go.setInactive();
                                            // Tell the game state a coin as been found
                                            gs.coinCollected();
                                        break;
                                    ...
                                    case "Collectible with 3": // Left
                                        ...
                                        // Switch off coin
                                        go.setInactive();
                                        // Tell the game state a coin ahs been found
                                        gs.coinCollected();
                                        break;
                                    ...
                                    case "Inert Tile with 3":
                                        ...
                                        playersLocation.x =
                                                testedLocation.x + testedTransform.getSize().x;
                                        break;
