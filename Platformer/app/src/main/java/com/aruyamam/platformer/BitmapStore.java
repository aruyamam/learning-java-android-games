...
class BitmapStore {
    ...
    private static Map<String, Bitmap> mBitmapReversedMap;
    ...
    static Bitmap getBitmapReversed(String bitmapName) {
        if (mBitmapReversedMap.containsKey(bitmapName)) {
            ...
            return mBitmapReversedMap.get("death_visible");
        }
    }
    ...
    static void addBitmap(Context c,
        ...
        bitmap = Bitmap.createScaledBitmap(
                bitmap,
                (int) objectSize.x * pixelsPerMeter,
                (int) objectSize.y * pixelsPerMeter,
                false);
