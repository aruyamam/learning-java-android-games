...
class SnakeGame extends SurfaceView implements Runnable {
    ...
    // Is the game currentlyplaying and or pause?
    ...
    // The size in segments of the playablle are
    ...
    public SnakeGame(Context context, Point size) {
        ...
        try {
            ...
            descriptor = assetManager.openNonAssetFd("snake_death.ogg");
        ...
        // Call the constructor of our two game objects
        mApple = new Apple(
                context,
    ...
    public void newGame() {
        ...
        // Setup mNextFrameTime so an update can triggerd
    ...
    public void draw() {
        ...
        if (mSurfaceHolder.getSurface().isValid()) {
            ...
            if (mPaused) {
                // Set the size and color of mPaint for the next
                mPaint.setColor(Color.argb(255, 255,255,255));
