package com.aruyamam.subhunter;
...
public class SubHunter extends Activity {
    ...
    // Here are all the objects(instance)
    ...
    /*
        ...
        the code for teh one-time setup phase.
     */
    ...
    /*
        ...
        nad after the player wins a game.
     */
    void newGame() {
    ...
    /*
        Here we wwill do all the drawing.
    ...
    void printDebuggingText() {
        ...
        canvas.drawText("girdWidth = " + gridWidth,  50, blockSize * 6, paint);

        canvas.drawText("girdHeighht= " + gridHeight,  50, blockSize * 7, paint);
